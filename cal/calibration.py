...
class MyUI(QWidget):
    ...
    def initUI(self):
        ...
        if nConnectionNum == 0:
            self.map_points = [[(552, 978), (925, 1043), (709, 333), (1049, 364)], [(365, 2265), (415, 505), (1268, 346), (1397, 505)]]
        ...
        if self.state == 'R':
            if nConnectionNum == 0:
                ...
                right_image_path = "images/pointed_red.png"
            elif nConnectionNum == 1:
                self.save_path = 'arrays_test_red.npy'
                right_image_path = "images/pointed_red_far.png"  # 替换为右边图片的路径
        else:
            if nConnectionNum == 0:
                self.save_path = 'arrays_test_blue.npy'
                right_image_path = "images/pointed_blue.png" 
            elif nConnectionNum == 1:
                self.save_path = 'arrays_test_blue.npy'
                right_image_path = "images/pointed_blue_far.png"  # 替换为右边图片的路径
